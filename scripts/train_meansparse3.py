...
def main():
        ...
        for name, module in model.named_modules():
            if isinstance(module, MeanSparse):
                ...
                if f"{name}.batch_num" not in state_dict:
                    state_dict[f"{name}.batch_num"] = th.tensor(5005, dtype=module.batch_num.dtype, device=module.batch_num.device)
        return state_dict
    ...
    save_classifiers(meansparse_classifiers_ddp, 'meansparse_classifiers_t400.pth')
